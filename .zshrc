...
ZSH_WEB_SEARCH_ENGINES=(
  dict "https://dictionary.cambridge.org/dictionary/english-chinese-traditional/"
...
plugins=(pip zsh-syntax-highlighting zsh-autosuggestions web-search copypath 
  jsontools ufw urltools)
...
# fzf
export FZF_DEFAULT_OPTS="--scroll-off 3 --bind change:top --height 50% --reverse --color=border:#6B6B6B,spinner:#98BC99,hl:#68ca7c,fg:#D9D9D9,header:#719872,info:#BDBB72,pointer:#E12672,marker:#E17899,fg+:#D9D9D9,prompt:#98BEDE,hl+:#7ae471,scrollbar:blue"
...
export FZF_ALT_C_OPTS="--preview 'tree -C {} | head -150'
